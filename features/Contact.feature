...
2. run the following command:
  ...
  Scenario Outline: Get data
    * Get the service api "<URL>" and i should get the '<expectval>'
    Examples: 
      | URL                           | expectval                                                                                                                                                           |
      | http://localhost:1111/contactdetails | "Message sent."                   |

  Scenario Outline: Post data
    * Post to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                         | data                                            | expectval                                       |
      | http://localhost:1111/contact | { "Name": "Hello", "Email": "Zack@asd.com", "Phone": "9999", "Message": "asdf"} |  "Message Sent to the Admin"  |