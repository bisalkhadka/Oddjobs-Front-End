...
2. run the following command:
  ...
  Scenario Outline: Post data
    * Post to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                         | data                                            | expectval                                       |
      | http://localhost:1111/comments | { "userid":"5dbefeb399761844e4db9b1c","jid":"5dbf1039bcbb4d45c46f10e5","Username": "Hello", "Email": "Zack@asd.com", "Education": "9999", "Qualification": "asdf", "Experience": "+2"} |  "Your application is sent."  |
